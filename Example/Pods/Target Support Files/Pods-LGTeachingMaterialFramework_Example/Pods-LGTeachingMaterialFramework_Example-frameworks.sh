...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/YJFontAlertView/YJFontAlertView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/YJResizableSplitView/YJResizableSplitView.framework"
